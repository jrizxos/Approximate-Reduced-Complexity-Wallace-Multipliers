...
uint64_t ARCWM_32x32(uint32_t a, uint32_t b, uint8_t* vars){
    ...
    enum sum {s10060,s10059,s10058,s10057,s10056,s10055,s10054,s10053,s10052,//STAGE1
            ...
            s80018,s80017,s80016,s80015,s80014,s80013,s80012,s80011,s80010,s80009};
    
    int par_num = 32;                                                           // partial products number
    int sum_num = 930;                                                          // sums number 930 = 907FA + 23HA
    ...
    sums[s40005] = ax_full_adder(sums[s20005]&1, (sums[s20004]&2)>>1, (sums[s30004]&2)>>1, vars[676]);
    sums[s40008] = ax_full_adder(sums[s30008]&1, (sums[s30007]&2)>>1, sums[s10208]&1, vars[677]);
    ...
    sums[s40011] = ax_full_adder(sums[s30011]&1, (sums[s30010]&2)>>1, (sums[s20110]&2)>>1, vars[680]);
    sums[s40012] = ax_full_adder(sums[s30012]&1, (sums[s30011]&2)>>1, (sums[s20111]&2)>>1, vars[681]);
    ...
    sums[s40052] = ax_full_adder(sums[s30052]&1, (sums[s30051]&2)>>1, (sums[s20151]&2)>>1, vars[721]);
    ...
    sums[s40055] = ax_full_adder(sums[s30055]&1, (sums[s30054]&2)>>1, (sums[s20154]&2)>>1, vars[724]);
    sums[s40056] = ax_full_adder(sums[s30056]&1, (sums[s30055]&2)>>1, partials[31][25], vars[725]);
    sums[s40058] = ax_full_adder(sums[s30058]&1, (sums[s30057]&2)>>1, (sums[s10157]&2)>>1, vars[726]);
    sums[s40059] = ax_full_adder(sums[s20059]&1, (sums[s20058]&2)>>1, (sums[s30058]&2)>>1, vars[727]);
    sums[s40115] = ax_full_adder((sums[s30114]&2)>>1, (sums[s10414]&2)>>1, partials[15][0], vars[728]);
    sums[s40118] = ax_full_adder((sums[s30117]&2)>>1, sums[s20318]&1, partials[18][0], vars[729]);
    sums[s40119] = ax_full_adder((sums[s30118]&2)>>1, sums[s30219]&1, partials[19][0], vars[730]);
    ...
    sums[s40145] = ax_full_adder((sums[s30144]&2)>>1, sums[s20345]&1, (sums[s20344]&2)>>1, vars[756]);
    sums[s40147] = ax_full_adder((sums[s30146]&2)>>1, sums[s30247]&1, (sums[s30246]&2)>>1, vars[757]);
    sums[s40148] = ax_full_adder((sums[s30147]&2)>>1, (sums[s10447]&2)>>1, (sums[s30247]&2)>>1, vars[758]);
    sums[s40149] = ax_full_adder((sums[s30148]&2)>>1, partials[31][18], (sums[s10448]&2)>>1, vars[759]);
    sums[s40225] = ax_full_adder((sums[s20424]&2)>>1, sums[s20525]&1, (sums[s30324]&2)>>1, vars[760]);
    sums[s40228] = ax_full_adder(sums[s30328]&1, (sums[s30327]&2)>>1, partials[27][1], vars[761]);
    ...
    sums[s40235] = ax_full_adder(sums[s30335]&1, (sums[s30334]&2)>>1, partials[31][4], vars[768]);
    sums[s40237] = ax_full_adder(sums[s30337]&1, (sums[s30336]&2)>>1, (sums[s10836]&2)>>1, vars[769]);
    sums[s40238] = ax_full_adder(sums[s30338]&1, (sums[s30337]&2)>>1, (sums[s20537]&2)>>1, vars[770]);
    sums[s40239] = ax_full_adder((sums[s20438]&2)>>1, (sums[s10738]&2)>>1, (sums[s30338]&2)>>1, vars[771]);
    sums[s50006] = ax_full_adder(sums[s30006]&1, partials[6][0], (sums[s40005]&2)>>1, vars[772]);
    sums[s50011] = ax_full_adder(sums[s40011]&1, (sums[s40010]&2)>>1, sums[s10311]&1, vars[773]);
    sums[s50012] = ax_full_adder(sums[s40012]&1, (sums[s40011]&2)>>1, sums[s20212]&1, vars[774]);
    sums[s50013] = ax_full_adder(sums[s40013]&1, (sums[s40012]&2)>>1, partials[13][0], vars[775]);
    sums[s50014] = ax_full_adder(sums[s40014]&1, (sums[s40013]&2)>>1, (sums[s30113]&2)>>1, vars[776]);
    sums[s50015] = ax_full_adder(sums[s40015]&1, (sums[s40014]&2)>>1, sums[s40115]&1, vars[777]);
    sums[s50016] = ax_full_adder(sums[s40016]&1, (sums[s40015]&2)>>1, (sums[s30115]&2)>>1, vars[778]);
    sums[s50017] = ax_full_adder(sums[s40017]&1, (sums[s40016]&2)>>1, (sums[s30116]&2)>>1, vars[779]);
    sums[s50018] = ax_full_adder(sums[s40018]&1, (sums[s40017]&2)>>1, sums[s40118]&1, vars[780]);
    sums[s50019] = ax_full_adder(sums[s40019]&1, (sums[s40018]&2)>>1, sums[s40119]&1, vars[781]);
    sums[s50020] = ax_full_adder(sums[s40020]&1, (sums[s40019]&2)>>1, sums[s40120]&1, vars[782]);
    sums[s50021] = ax_full_adder(sums[s40021]&1, (sums[s40020]&2)>>1, sums[s40121]&1, vars[783]);
    sums[s50022] = ax_full_adder(sums[s40022]&1, (sums[s40021]&2)>>1, sums[s40122]&1, vars[784]);
    sums[s50023] = ax_full_adder(sums[s40023]&1, (sums[s40022]&2)>>1, sums[s40123]&1, vars[785]);
    sums[s50024] = ax_full_adder(sums[s40024]&1, (sums[s40023]&2)>>1, sums[s40124]&1, vars[786]);
    sums[s50025] = ax_full_adder(sums[s40025]&1, (sums[s40024]&2)>>1, sums[s40125]&1, vars[787]);
    sums[s50026] = ax_full_adder(sums[s40026]&1, (sums[s40025]&2)>>1, sums[s40126]&1, vars[788]);
    sums[s50027] = ax_full_adder(sums[s40027]&1, (sums[s40026]&2)>>1, sums[s40127]&1, vars[789]);
    sums[s50028] = ax_full_adder(sums[s40028]&1, (sums[s40027]&2)>>1, sums[s40128]&1, vars[790]);
    sums[s50029] = ax_full_adder(sums[s40029]&1, (sums[s40028]&2)>>1, sums[s40129]&1, vars[791]);
    sums[s50030] = ax_full_adder(sums[s40030]&1, (sums[s40029]&2)>>1, sums[s40130]&1, vars[792]);
    sums[s50031] = ax_full_adder(sums[s40031]&1, (sums[s40030]&2)>>1, sums[s40131]&1, vars[793]);
    sums[s50032] = ax_full_adder(sums[s40032]&1, (sums[s40031]&2)>>1, sums[s40132]&1, vars[794]);
    sums[s50033] = ax_full_adder(sums[s40033]&1, (sums[s40032]&2)>>1, sums[s40133]&1, vars[795]);
    sums[s50034] = ax_full_adder(sums[s40034]&1, (sums[s40033]&2)>>1, sums[s40134]&1, vars[796]);
    sums[s50035] = ax_full_adder(sums[s40035]&1, (sums[s40034]&2)>>1, sums[s40135]&1, vars[797]);
    sums[s50036] = ax_full_adder(sums[s40036]&1, (sums[s40035]&2)>>1, sums[s40136]&1, vars[798]);
    sums[s50037] = ax_full_adder(sums[s40037]&1, (sums[s40036]&2)>>1, sums[s40137]&1, vars[799]);
    sums[s50038] = ax_full_adder(sums[s40038]&1, (sums[s40037]&2)>>1, sums[s40138]&1, vars[800]);
    sums[s50039] = ax_full_adder(sums[s40039]&1, (sums[s40038]&2)>>1, sums[s40139]&1, vars[801]);
    sums[s50040] = ax_full_adder(sums[s40040]&1, (sums[s40039]&2)>>1, sums[s40140]&1, vars[802]);
    sums[s50041] = ax_full_adder(sums[s40041]&1, (sums[s40040]&2)>>1, sums[s40141]&1, vars[803]);
    sums[s50042] = ax_full_adder(sums[s40042]&1, (sums[s40041]&2)>>1, sums[s40142]&1, vars[804]);
    sums[s50043] = ax_full_adder(sums[s40043]&1, (sums[s40042]&2)>>1, sums[s40143]&1, vars[805]);
    sums[s50044] = ax_full_adder(sums[s40044]&1, (sums[s40043]&2)>>1, sums[s40144]&1, vars[806]);
    sums[s50045] = ax_full_adder(sums[s40045]&1, (sums[s40044]&2)>>1, sums[s40145]&1, vars[807]);
    sums[s50046] = ax_full_adder(sums[s40046]&1, (sums[s40045]&2)>>1, (sums[s30145]&2)>>1, vars[808]);
    sums[s50047] = ax_full_adder(sums[s40047]&1, (sums[s40046]&2)>>1, sums[s40147]&1, vars[809]);
    sums[s50048] = ax_full_adder(sums[s40048]&1, (sums[s40047]&2)>>1, sums[s40148]&1, vars[810]);
    sums[s50049] = ax_full_adder(sums[s40049]&1, (sums[s40048]&2)>>1, sums[s40149]&1, vars[811]);
    sums[s50050] = ax_full_adder(sums[s40050]&1, (sums[s40049]&2)>>1, (sums[s30149]&2)>>1, vars[812]);
    sums[s50051] = ax_full_adder(sums[s40051]&1, (sums[s40050]&2)>>1, (sums[s30150]&2)>>1, vars[813]);
    sums[s50052] = ax_full_adder(sums[s40052]&1, (sums[s40051]&2)>>1, sums[s20252]&1, vars[814]);
    sums[s50054] = ax_full_adder(sums[s40054]&1, (sums[s40053]&2)>>1, (sums[s30153]&2)>>1, vars[815]);
    sums[s50055] = ax_full_adder(sums[s40055]&1, (sums[s40054]&2)>>1, (sums[s10254]&2)>>1, vars[816]);
    sums[s50056] = ax_full_adder(sums[s40056]&1, (sums[s40055]&2)>>1, (sums[s20155]&2)>>1, vars[817]);
    sums[s50057] = ax_full_adder(sums[s30057]&1, (sums[s30056]&2)>>1, (sums[s40056]&2)>>1, vars[818]);
    sums[s50122] = ax_full_adder((sums[s40121]&2)>>1, (sums[s20421]&2)>>1, partials[22][0], vars[819]);
    sums[s50126] = ax_full_adder((sums[s40125]&2)>>1, sums[s30326]&1, (sums[s20525]&2)>>1, vars[820]);
    sums[s50127] = ax_full_adder((sums[s40126]&2)>>1, sums[s30327]&1, (sums[s30326]&2)>>1, vars[821]);
    sums[s50128] = ax_full_adder((sums[s40127]&2)>>1, sums[s40228]&1, partials[28][0], vars[822]);
    ...
    sums[s50136] = ax_full_adder((sums[s40135]&2)>>1, sums[s30336]&1, (sums[s30335]&2)>>1, vars[830]);
    sums[s50138] = ax_full_adder((sums[s40137]&2)>>1, sums[s40238]&1, (sums[s40237]&2)>>1, vars[831]);
    sums[s50139] = ax_full_adder((sums[s40138]&2)>>1, sums[s40239]&1, (sums[s40238]&2)>>1, vars[832]);
    sums[s50140] = ax_full_adder((sums[s40139]&2)>>1, sums[s30340]&1, (sums[s40239]&2)>>1, vars[833]);
    sums[s50141] = ax_full_adder((sums[s40140]&2)>>1, (sums[s20440]&2)>>1, (sums[s30340]&2)>>1, vars[834]);
    sums[s50142] = ax_full_adder((sums[s40141]&2)>>1, (sums[s10641]&2)>>1, (sums[s20441]&2)>>1, vars[835]);
    sums[s60007] = ax_full_adder(sums[s30007]&1, (sums[s30006]&2)>>1, (sums[s50006]&2)>>1, vars[836]);
    sums[s60016] = ax_full_adder(sums[s50016]&1, (sums[s50015]&2)>>1, sums[s20316]&1, vars[837]);
    sums[s60017] = ax_full_adder(sums[s50017]&1, (sums[s50016]&2)>>1, sums[s30217]&1, vars[838]);
    sums[s60018] = ax_full_adder(sums[s50018]&1, (sums[s50017]&2)>>1, (sums[s30217]&2)>>1, vars[839]);
    ...
    sums[s60022] = ax_full_adder(sums[s50022]&1, (sums[s50021]&2)>>1, sums[s50122]&1, vars[843]);
    sums[s60023] = ax_full_adder(sums[s50023]&1, (sums[s50022]&2)>>1, (sums[s40122]&2)>>1, vars[844]);
    sums[s60024] = ax_full_adder(sums[s50024]&1, (sums[s50023]&2)>>1, (sums[s40123]&2)>>1, vars[845]);
    sums[s60025] = ax_full_adder(sums[s50025]&1, (sums[s50024]&2)>>1, (sums[s40124]&2)>>1, vars[846]);
    sums[s60026] = ax_full_adder(sums[s50026]&1, (sums[s50025]&2)>>1, sums[s50126]&1, vars[847]);
    sums[s60027] = ax_full_adder(sums[s50027]&1, (sums[s50026]&2)>>1, sums[s50127]&1, vars[848]);
    sums[s60028] = ax_full_adder(sums[s50028]&1, (sums[s50027]&2)>>1, sums[s50128]&1, vars[849]);
    ...
    sums[s60037] = ax_full_adder(sums[s50037]&1, (sums[s50036]&2)>>1, (sums[s40136]&2)>>1, vars[858]);
    ...
    sums[s60042] = ax_full_adder(sums[s50042]&1, (sums[s50041]&2)>>1, sums[s50142]&1, vars[863]);
    ...
    sums[s60046] = ax_full_adder(sums[s50046]&1, (sums[s50045]&2)>>1, sums[s30246]&1, vars[867]);
    sums[s60048] = ax_full_adder(sums[s50048]&1, (sums[s50047]&2)>>1, (sums[s40147]&2)>>1, vars[868]);
    sums[s60049] = ax_full_adder(sums[s50049]&1, (sums[s50048]&2)>>1, (sums[s40148]&2)>>1, vars[869]);
    sums[s60050] = ax_full_adder(sums[s50050]&1, (sums[s50049]&2)>>1, (sums[s40149]&2)>>1, vars[870]);
    sums[s60051] = ax_full_adder(sums[s50051]&1, (sums[s50050]&2)>>1, (sums[s20250]&2)>>1, vars[871]);
    sums[s60052] = ax_full_adder(sums[s50052]&1, (sums[s50051]&2)>>1, (sums[s30151]&2)>>1, vars[872]);
    sums[s60053] = ax_full_adder(sums[s40053]&1, (sums[s40052]&2)>>1, (sums[s50052]&2)>>1, vars[873]);
    sums[s70008] = ax_full_adder(sums[s40008]&1, (sums[s20107]&2)>>1, (sums[s60007]&2)>>1, vars[874]);
    sums[s70023] = ax_full_adder(sums[s60023]&1, (sums[s60022]&2)>>1, (sums[s20422]&2)>>1, vars[875]);
    sums[s70024] = ax_full_adder(sums[s60024]&1, (sums[s60023]&2)>>1, sums[s30324]&1, vars[876]);
    sums[s70025] = ax_full_adder(sums[s60025]&1, (sums[s60024]&2)>>1, sums[s40225]&1, vars[877]);
    sums[s70026] = ax_full_adder(sums[s60026]&1, (sums[s60025]&2)>>1, (sums[s40225]&2)>>1, vars[878]);
    sums[s70027] = ax_full_adder(sums[s60027]&1, (sums[s60026]&2)>>1, (sums[s50126]&2)>>1, vars[879]);
    sums[s70028] = ax_full_adder(sums[s60028]&1, (sums[s60027]&2)>>1, (sums[s50127]&2)>>1, vars[880]);
    sums[s70029] = ax_full_adder(sums[s60029]&1, (sums[s60028]&2)>>1, (sums[s50128]&2)>>1, vars[881]);
    sums[s70030] = ax_full_adder(sums[s60030]&1, (sums[s60029]&2)>>1, (sums[s50129]&2)>>1, vars[882]);
    sums[s70031] = ax_full_adder(sums[s60031]&1, (sums[s60030]&2)>>1, (sums[s50130]&2)>>1, vars[883]);
    sums[s70032] = ax_full_adder(sums[s60032]&1, (sums[s60031]&2)>>1, (sums[s50131]&2)>>1, vars[884]);
    sums[s70033] = ax_full_adder(sums[s60033]&1, (sums[s60032]&2)>>1, (sums[s50132]&2)>>1, vars[885]);
    sums[s70034] = ax_full_adder(sums[s60034]&1, (sums[s60033]&2)>>1, (sums[s50133]&2)>>1, vars[886]);
    sums[s70035] = ax_full_adder(sums[s60035]&1, (sums[s60034]&2)>>1, (sums[s50134]&2)>>1, vars[887]);
    sums[s70036] = ax_full_adder(sums[s60036]&1, (sums[s60035]&2)>>1, (sums[s50135]&2)>>1, vars[888]);
    sums[s70037] = ax_full_adder(sums[s60037]&1, (sums[s60036]&2)>>1, sums[s40237]&1, vars[889]);
    sums[s70039] = ax_full_adder(sums[s60039]&1, (sums[s60038]&2)>>1, (sums[s50138]&2)>>1, vars[890]);
    sums[s70040] = ax_full_adder(sums[s60040]&1, (sums[s60039]&2)>>1, (sums[s50139]&2)>>1, vars[891]);
    sums[s70041] = ax_full_adder(sums[s60041]&1, (sums[s60040]&2)>>1, (sums[s50140]&2)>>1, vars[892]);
    sums[s70042] = ax_full_adder(sums[s60042]&1, (sums[s60041]&2)>>1, (sums[s50141]&2)>>1, vars[893]);
    sums[s70043] = ax_full_adder(sums[s60043]&1, (sums[s60042]&2)>>1, (sums[s50142]&2)>>1, vars[894]);
    sums[s70044] = ax_full_adder(sums[s60044]&1, (sums[s60043]&2)>>1, (sums[s20443]&2)>>1, vars[895]);
    sums[s70045] = ax_full_adder(sums[s60045]&1, (sums[s60044]&2)>>1, (sums[s30244]&2)>>1, vars[896]);
    sums[s70046] = ax_full_adder(sums[s60046]&1, (sums[s60045]&2)>>1, (sums[s40145]&2)>>1, vars[897]);
    sums[s70047] = ax_full_adder(sums[s50047]&1, (sums[s50046]&2)>>1, (sums[s60046]&2)>>1, vars[898]);
    sums[s80009] = ax_full_adder(sums[s40009]&1, (sums[s40008]&2)>>1, (sums[s70008]&2)>>1, vars[899]);
    sums[s80010] = half_adder(sums[s40010]&1, (sums[s40009]&2)>>1);
    sums[s80011] = half_adder(sums[s50011]&1, (sums[s30110]&2)>>1);
    sums[s80012] = half_adder(sums[s50012]&1, (sums[s50011]&2)>>1);
    sums[s80013] = half_adder(sums[s50013]&1, (sums[s50012]&2)>>1);
    sums[s80014] = half_adder(sums[s50014]&1, (sums[s50013]&2)>>1);
    sums[s80015] = half_adder(sums[s50015]&1, (sums[s50014]&2)>>1);
    sums[s80016] = half_adder(sums[s60016]&1, (sums[s40115]&2)>>1);
    sums[s80017] = half_adder(sums[s60017]&1, (sums[s60016]&2)>>1);
    sums[s80018] = half_adder(sums[s60018]&1, (sums[s60017]&2)>>1);
    sums[s80019] = half_adder(sums[s60019]&1, (sums[s60018]&2)>>1);
    sums[s80020] = half_adder(sums[s60020]&1, (sums[s60019]&2)>>1);
    sums[s80021] = half_adder(sums[s60021]&1, (sums[s60020]&2)>>1);
    sums[s80022] = half_adder(sums[s60022]&1, (sums[s60021]&2)>>1);
    sums[s80023] = half_adder(sums[s70023]&1, (sums[s50122]&2)>>1);
    sums[s80024] = half_adder(sums[s70024]&1, (sums[s70023]&2)>>1);
    sums[s80025] = half_adder(sums[s70025]&1, (sums[s70024]&2)>>1);
    sums[s80026] = half_adder(sums[s70026]&1, (sums[s70025]&2)>>1);
    sums[s80027] = half_adder(sums[s70027]&1, (sums[s70026]&2)>>1);
    sums[s80028] = half_adder(sums[s70028]&1, (sums[s70027]&2)>>1);
    ...
    sums[s80032] = ax_full_adder(sums[s70032]&1, (sums[s70031]&2)>>1, (sums[s30431]&2)>>1, vars[900]);
    sums[s80033] = ax_full_adder(sums[s70033]&1, (sums[s70032]&2)>>1, (sums[s30432]&2)>>1, vars[901]);
    sums[s80034] = ax_full_adder(sums[s70034]&1, (sums[s70033]&2)>>1, (sums[s30433]&2)>>1, vars[902]);
    sums[s80035] = ax_full_adder(sums[s70035]&1, (sums[s70034]&2)>>1, (sums[s20634]&2)>>1, vars[903]);
    sums[s80036] = ax_full_adder(sums[s70036]&1, (sums[s70035]&2)>>1, (sums[s40235]&2)>>1, vars[904]);
    sums[s80037] = ax_full_adder(sums[s70037]&1, (sums[s70036]&2)>>1, (sums[s50136]&2)>>1, vars[905]);
    sums[s80038] = ax_full_adder(sums[s60038]&1, (sums[s60037]&2)>>1, (sums[s70037]&2)>>1, vars[906]);
    ...
    prodA |= (sums[s40005]&1) << 5;
    prodA |= (sums[s50006]&1) << 6;
    prodA |= (sums[s60007]&1) << 7;
    prodA |= (sums[s70008]&1) << 8;
    prodA |= (sums[s80009]&1) << 9;
    prodA |= (sums[s80010]&1) << 10;
    prodA |= (sums[s80011]&1) << 11;
    prodA |= (sums[s80012]&1) << 12;
    prodA |= (sums[s80013]&1) << 13;
    prodA |= (sums[s80014]&1) << 14;
    prodA |= (sums[s80015]&1) << 15;
    prodA |= (sums[s80016]&1) << 16;
    prodA |= (sums[s80017]&1) << 17;
    prodA |= (sums[s80018]&1) << 18;
    prodA |= (sums[s80019]&1) << 19;
    prodA |= (sums[s80020]&1) << 20;
    prodA |= (sums[s80021]&1) << 21;
    prodA |= (sums[s80022]&1) << 22;
    ...
    prodA |= ((uint64_t)sums[s70039]&1) << 39;
    prodA |= ((uint64_t)sums[s70040]&1) << 40;
    prodA |= ((uint64_t)sums[s70041]&1) << 41;
    prodA |= ((uint64_t)sums[s70042]&1) << 42;
    prodA |= ((uint64_t)sums[s70043]&1) << 43;
    prodA |= ((uint64_t)sums[s70044]&1) << 44;
    prodA |= ((uint64_t)sums[s70045]&1) << 45;
    prodA |= ((uint64_t)sums[s70046]&1) << 46;
    prodA |= ((uint64_t)sums[s70047]&1) << 47;
    prodA |= ((uint64_t)sums[s60048]&1) << 48;
    prodA |= ((uint64_t)sums[s60049]&1) << 49;
    prodA |= ((uint64_t)sums[s60050]&1) << 50;
    prodA |= ((uint64_t)sums[s60051]&1) << 51;
    prodA |= ((uint64_t)sums[s60052]&1) << 52;
    prodA |= ((uint64_t)sums[s60053]&1) << 53;
    prodA |= ((uint64_t)sums[s50054]&1) << 54;
    prodA |= ((uint64_t)sums[s50055]&1) << 55;
    prodA |= ((uint64_t)sums[s50056]&1) << 56;
    prodA |= ((uint64_t)sums[s50057]&1) << 57;
    prodA |= ((uint64_t)sums[s40058]&1) << 58;
    prodA |= ((uint64_t)sums[s40059]&1) << 59;
    prodA |= ((uint64_t)sums[s30060]&1) << 60;
    prodA |= ((uint64_t)sums[s20061]&1) << 61;
    prodA |= ((uint64_t)partials[31][31]) << 62;
    prodB |= ((int)partials[1][0]) << 1;
    prodB |= (sums[s80009]&2) << 9;
    prodB |= (sums[s80010]&2) << 10;
    prodB |= (sums[s80011]&2) << 11;
    prodB |= (sums[s80012]&2) << 12;
    prodB |= (sums[s80013]&2) << 13;
    prodB |= (sums[s80014]&2) << 14;
    prodB |= (sums[s80015]&2) << 15;
    prodB |= (sums[s80016]&2) << 16;
    prodB |= (sums[s80017]&2) << 17;
    prodB |= (sums[s80018]&2) << 18;
    prodB |= (sums[s80019]&2) << 19;
    prodB |= (sums[s80020]&2) << 20;
    prodB |= (sums[s80021]&2) << 21;
    prodB |= (sums[s80022]&2) << 22;
    ...
    prodB |= ((uint64_t)sums[s70039]&2) << 39;
    prodB |= ((uint64_t)sums[s70040]&2) << 40;
    prodB |= ((uint64_t)sums[s70041]&2) << 41;
    prodB |= ((uint64_t)sums[s70042]&2) << 42;
    prodB |= ((uint64_t)sums[s70043]&2) << 43;
    prodB |= ((uint64_t)sums[s70044]&2) << 44;
    prodB |= ((uint64_t)sums[s70045]&2) << 45;
    prodB |= ((uint64_t)sums[s70046]&2) << 46;
    prodB |= ((uint64_t)sums[s70047]&2) << 47;
    prodB |= ((uint64_t)sums[s60048]&2) << 48;
    prodB |= ((uint64_t)sums[s60049]&2) << 49;
    prodB |= ((uint64_t)sums[s60050]&2) << 50;
    prodB |= ((uint64_t)sums[s60051]&2) << 51;
    prodB |= ((uint64_t)sums[s60052]&2) << 52;
    prodB |= ((uint64_t)sums[s60053]&2) << 53;
    prodB |= ((uint64_t)sums[s50054]&2) << 54;
    prodB |= ((uint64_t)sums[s50055]&2) << 55;
    prodB |= ((uint64_t)sums[s50056]&2) << 56;
    prodB |= ((uint64_t)sums[s50057]&2) << 57;
    prodB |= ((uint64_t)sums[s40058]&2) << 58;
    prodB |= ((uint64_t)sums[s40059]&2) << 59;
    prodB |= ((uint64_t)sums[s30060]&2) << 60;
    prodB |= ((uint64_t)sums[s20061]&2) << 61;
